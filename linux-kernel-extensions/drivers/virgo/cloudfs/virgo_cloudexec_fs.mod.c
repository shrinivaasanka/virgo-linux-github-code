...
__attribute__((section("__versions"))) = {
	...
	{ 0xbdb1002f, "vfs_read" },
	{ 0x50eedeb8, "printk" },
	{ 0xaca30e76, "virgo_cloud_write_kernelspace" },
	{ 0xb4390f9a, "mcount" },
	{ 0x2922e680, "virgo_cloud_open_kernelspace" },
	{ 0x64c0ec, "num_cloud_nodes" },
	{ 0x952664c5, "do_exit" },
	{ 0x61651be, "strcat" },
	{ 0xfe26f191, "node_ip_addrs_in_cloud" },
	{ 0xb6c37ef3, "virgo_cloud_read_kernelspace" },
	...
	{ 0x66501a, "virgo_cloud_close_kernelspace" },
...
MODULE_INFO(srcversion, "80496EF103C7FBC92215CF8");
